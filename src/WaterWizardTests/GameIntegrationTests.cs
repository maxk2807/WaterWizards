...
namespace WaterWizardTests
{
    ...
    public static class TestHelpers
    {
        ...
        public static bool PlaceShip(int playerIndex, int x, int y, ShipType shipType, ShipOrientation orientation)
        {
            return x >= 0 && x < 12 && y >= 0 && y < 10;
        }
    ...
    public class GameIntegrationTests
    {
        ...
        public void GameState_NetworkAndGameLogicIntegration_WorksTogether()
        {
            ...
            var playerIndex = gameState.players[0] != null ? gameState.GetPlayerIndex(gameState.players[0]) : -1;
        ...
        public void GameState_CellStateAndAttackIntegration_UpdatesCorrectly()
        {
            ...
            var shipPlaced = TestHelpers.PlaceShip(0, 3, 3, ShipType.Submarine, ShipOrientation.Horizontal);
